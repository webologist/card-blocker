...
function buildContactEmail(d, receivedAt) {
  ...
  // Fixed subject so these are recognisable at a glance in the support inbox.
  // The sender's own subject is not lost - it stays in the table below.
  return { subject: 'Message from website', html, text };
}
